...
class VGGnet(nn.Module):
    def __init__(self, cfg_list, activation=None, drop_prob=0.2, num_classes=100, batch_norm=True, init_weight=True):
    ...
    def forward(self, input_tensor):
        ...
        #print('In model input_tensor size:{}, device:{}'.format(input_tensor.size(), input_tensor.device))
